...
function App() {
  ...
  return (
    <Root>
      <Head>
        <meta name="description" content="Quality in-ground swimming pool installation, we also do lap pools and water features. London's trusted swimming pool contractors" />
